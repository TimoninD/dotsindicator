...
class ViewPager2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Handler().postDelayed({ dotsIndicator.pager?.realCount = 10 }, 5000)
        dotsIndicator.pager?.realCount = 10
        Handler().postDelayed({ dotsIndicator.pager?.realCount = 10 }, 10000)
        dotsIndicator.pager?.realCount = 2
